...
function createMenu()
{
	...
	liCurId = buf[buf.length - 1];
	liCur = document.getElementById(liCurId);
...
{
    document.getElementById('interestsMenu').style.visibility = 'visible';
    document.getElementById('interestsMenu').style.display = 'block';
}

function hideInterestsMenu()
{
    document.getElementById('interestsMenu').style.visibility = 'hidden';
    document.getElementById('interestsMenu').style.display = 'none';
}