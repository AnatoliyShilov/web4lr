	...
	var content = 
		'<div id = "controlPanel" style = "position: relative; display: block; text-align: center">' +
			'<div class = "rama background" style = "display: inline">' +
				'<div id = "leftArrow" style = "position: relative; display: inline"><img src = "images/leftArrow.jpg" onclick = "prevImg()"></div>' +
				'<div id = "indexOf" style = "position: relative; display: inline"> ' + (index + 1) + ' из 15</div>' +
				'<div id = "rightArrow" style = "position: relative; display: inline"><img src = "images/rightArrow.jpg" onclick = "nextImg()"></div>' +
			'</div>'+
		'</div>' +
